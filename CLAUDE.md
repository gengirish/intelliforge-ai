...
- `lib/founder.ts` — founder name + "Founder" title, origin story, social links. The founder is deliberately cited **only as "Founder"** — don't re-add credentials, degrees, years of experience, employer history, or colleague recommendations anywhere on the site (pages, JSON-LD, `lib/llms-content.ts`) unless asked.
